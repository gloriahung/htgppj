    ...
    <div class="body-content">
        ...
        <table class="table table-hover" id= "table">
			...
			<tr class="active">
				...
				<td><?= Html::encode($recipeTitle[$reports->recipeId])?><?php if ($recipeTitle[$reports->recipeId]!='Recipe deleted'):?><a href= "removerecipe?recipeId=<?= $reports->recipeId ?>"><img src="../img/profileImg/banbutton.jpg" class="img-rounded" alt="delete button" title="delete button" width="20px" height="20px"  style="filter:alpha(opacity=50); opacity:.50; "><?php endif; ?></a></td>
